...
* The data used to train the model was obtained
  from [Kaggle](https://www.kaggle.com/datasets/noulam/tomato)
* Photo and icon credits
  to [depositphotos](https://depositphotos.com/stock-photos/tomato-plant-disease-leaf.html?sh=a63f9077ad7264e37870756f0d9527d26fb01a87)
...
* The design and functionality of the application was derived
  from [root458's project](https://github.com/root458/Plant-Disease-Detector)
